...
#            Copyright (C) 2023 Yasushi Ohsugi
#            Copyright (C) 2024 Yasushi Ohsugi
#            Copyright (C) 2025 Yasushi Ohsugi
#
...
# ******************************
    ...
    def load_data_files(self):
        ...
        #@250104 上のloading processは、load_data_files4INITIAL
    ...
    #@250104 MEMO 初期LOADの後 engineの連続処理はdemand planningで止まっている?
        #self.plan_through_engines4init()



        #@250104 STOP graph view be processed "after" supply_planning
        ## ****************************
        ## Graph viewing
        ## ****************************
        #
        ## ****************************
        ## network Graph viewing
        ## ****************************
